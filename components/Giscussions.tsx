      ...
      <div className="flex my-4 text-sm">
        ...
        <div className="w-full border border-blue-400 rounded-md border-opacity-30">
          ...
          <div>
            <style jsx>
              {`
                .reply:first-child > div:first-child {
                  top: 16px;
            ...
            <div className="relative pt-2 bg-gray-500 bg-opacity-5 reply">
              <div className="w-[2px] flex-shrink-0 bg-gray-500 bg-opacity-10 absolute left-[30px] z-20 h-full top-0"></div>
            ...
            <div className="relative pt-2 bg-gray-500 bg-opacity-5 reply">
              ...
              <div className="flex pt-2 pl-4">
                ...
                <div className="w-full ml-2">
                  ...
                  <div className="">
                    <div className="w-full py-4">Test reply again.</div>
                    <div className="flex content-center">
                      <button className="px-3 py-1 mb-4 mr-3 text-gray-900 text-opacity-75 border rounded hover:text-blue-600">
                        <SmileyIcon />
                      </button>
