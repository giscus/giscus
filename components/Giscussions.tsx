        ...
        <div className="w-full border border-blue-100 rounded-md">
          ...
          <div className="border-b rounded-b">
            ...
            <div className="flex content-center justify-between">
              <div className="ml-4">
                <button className="px-2 py-1 mr-2 text-sm border rounded">
                  <img
              ...
              <div className="mb-4 mr-4">
                <span className="text-sm text-gray-500">2 replies</span>
              </div>
            </div>
          </div>
          <div className="pt-2 bg-gray-50">
              ...
              <div className="w-full mb-6 ml-2">
                <div className="flex">
                  <h3 className="flex items-center flex-auto pt-1">
                    ...
                    <div className="hidden ml-2 text-xs sm:inline-flex">
                      <span className="px-1 ml-1 border border-blue-100 rounded-md">
                        Maintainer
                      </span>
                      <span className="px-1 ml-1 border border-blue-100 rounded-md">Author</span>
                    </div>
            ...
            <div className="flex px-4 py-2 border-t">
              ...
              <button className="w-full px-2 py-1 ml-2 text-sm text-left text-gray-600 bg-white border rounded">
                Write a reply
              </button>
            </div>
          </div>
